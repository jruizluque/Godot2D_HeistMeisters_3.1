...
const MAX_DETECTION_RANGE = 320 #640 in course, length of texture
...
func Player_in_FOV():
	...
	# it - me .normalized() to remove the magnitude of the vector
...
func Player_in_LOS():
	...
	var distance_to_player = Player.position.distance_to(global_position) #Player.global_position.dis... in course
